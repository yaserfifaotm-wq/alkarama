...
function setupEmployeesDatalist() {
    ...
    function renderSuggestions(list) {
        ...
        list.forEach((item, index) => {
            ...
            // عند النقر بالماوس على المقترح
            div.addEventListener("mousedown", (e) => {
                e.preventDefault(); // منع فقدان التركيز من الحقل الرئيسي
    ...
    // إغلاق المقترحات عند فقدان التركيز (blur)
    nameInput.addEventListener("blur", () => {
        // تأخير بسيط للسماح لحدث النقر (mousedown) بالعمل أولاً
        setTimeout(() => {
            suggestionsBox.classList.add("d-none");
            highlightedIndex = -1;
        }, 150);
